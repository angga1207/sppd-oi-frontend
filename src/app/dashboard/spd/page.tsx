...
export default function SpdListPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-bubblegum-800">Surat Perjalanan Dinas</h1>
        <p className="text-sm text-bubblegum-500 mt-1">Daftar SPD berdasarkan surat tugas</p>
      </div>
      ...
      <div className="glass-card rounded-3xl p-4 flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Cari nomor SPD, nama pegawai..."
            value={search}
      ...
      <div className="glass-card rounded-3xl overflow-hidden">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-bubblegum-300">
            ...
            <p className="text-sm font-medium">Belum ada SPD</p>
            <p className="text-xs mt-1">SPD dibuat otomatis dari surat tugas yang memiliki SPD</p>
          </div>
        ) : (
          <>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-bubblegum-100">
                    ...
                    <th className="text-left px-6 py-3 text-xs font-semibold text-bubblegum-500 uppercase tracking-wider">Pegawai</th>
                    ...
                    return (
                      <tr key={spd.id} className="hover:bg-bubblegum-50/50 transition-colors">
                        ...
                        <td className="px-6 py-3">
                          <p className="text-bubblegum-800 font-medium">{spd.surat_tugas_pegawai?.nama_lengkap || '-'}</p>
                          <p className="text-xs text-bubblegum-400">{spd.surat_tugas_pegawai?.nip || ''}</p>
                        </td>
